...
| [lidarr_search-missing-tracks](scripts/lidarr/lidarr_search-missing-tracks.sh)              | Bash        | N/A              | Script to go and hit the Lidarr API (suggest scheduling via a cron each night) to "force search" for any missing tracks against your indexers...
